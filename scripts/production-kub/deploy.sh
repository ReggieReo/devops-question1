...
docker build --no-cache --platform linux/amd64 -t $CONTAINER_REGISTRY/advertise:1 --file ../../advertise/Dockerfile-prod ../../advertise
...
docker build --no-cache --platform linux/amd64 -t $CONTAINER_REGISTRY/gateway:1 --file ../../gateway/Dockerfile-prod ../../gateway
